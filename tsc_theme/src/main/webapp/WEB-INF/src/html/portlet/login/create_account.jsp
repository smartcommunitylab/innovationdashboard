	...
	<aui:fieldset column="<%=true%>">
		<aui:col width="<%=100%>">
			...
			<c:if
				...
				<aui:input label="password" placeholder="password" name="password1"
					size="30" type="password" value="" />

				<aui:input label="enter-again" placeholder="enter-again"
					name="password2" size="30" type="password" value="">
